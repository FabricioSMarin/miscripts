...
# --- coeus ---
ssh -i ~/.ssh/ioc_launcher user2idd@coeus.xray.aps.anl.gov \
...
# --- 2iddnx ---
ssh -i ~/.ssh/ioc_launcher user2idd@2iddnx.xray.aps.anl.gov \
